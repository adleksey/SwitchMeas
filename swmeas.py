...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.vna = VNA()
        self.btn_connectVNA.clicked.connect(self.btn_connectVNAf)
    
    def btn_connectVNAf(self):
        if self.vna.connect("TCPIP0::192.168.0.222::5025::SOCKET"):
            self.label.setText(self.vna.getIDN())
        else:
